" Base16 my-base16 (https://github.com/chriskempson/base16)
" Scheme: Lukas Stevens (https://github.com/lukas-123)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-my-base-1-6.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-my-base-1-6"
